...
export default function NewNEMTRequestPage() {
    ...
    setFormData((prev) =>
      prev
        ? {
            ...
            service_checkboxes:
              request.service_checkboxes || prev.service_checkboxes,
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.invalidateQueries({ queryKey: ['nemt-requests', clientId] });
  ...
  if (clientLoading || !client || !formData) {
    return (
  ...
  // Check if broker is assigned
  if (!client.nemt_broker_id) {
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              For {client.full_name || client.user?.name}
            </p>
          </div>
        </div>
        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-6">
          <div className="flex items-start">
            <Truck className="w-6 h-6 mr-4 flex-shrink-0 text-red-600 dark:text-red-400" />
            <div>
              <h3 className="text-lg font-medium text-red-800 dark:text-red-400">
                No NEMT Broker Assigned
              </h3>
              <p className="mt-2 text-red-700 dark:text-red-300">
                This client does not have an NEMT broker assigned. Please assign
                a broker before creating transportation requests.
              </p>
              <Link
                href={`/clients/${clientId}`}
                className="mt-4 inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors"
              >
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {previousRequests.map((request) => (
                <button
                  ...
                  className="text-left border border-gray-200 dark:border-gray-700 hover:border-violet-300 dark:hover:border-violet-700 rounded-lg p-3 bg-gray-50 dark:bg-gray-900 hover:bg-violet-50 dark:hover:bg-violet-900/20 transition-colors"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <AddressAutocomplete
                ...
                errorMessage={errors.dropoff_address}
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          {timeWarnings.message && (
            <div
              className={cn(
                'mt-4 p-3 rounded-lg border flex items-start',
                timeWarnings.type === 'warning'
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 space-y-6">
              <div>
                ...
                <input
                  ...
                  className={cn(
                    'w-full md:w-1/2 px-4 py-2.5 border rounded-lg shadow-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-white',
                    errors.end_date
                      ? 'border-red-300'
                      : 'border-gray-300 dark:border-gray-600'
                  )}
                  ...
                  {(
                    ...
                    <label
                      ...
                      className={cn(
                        ...
                        formData.recurring_days[day]
                          ? 'bg-violet-100 dark:bg-violet-900/50 border-violet-300 dark:border-violet-700 text-violet-800 dark:text-violet-200'
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          updateRecurringDay(day, e.target.checked)
                        }
                        className="sr-only"
                      />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <textarea
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:text-white"
          />

          {formData.is_recurring && (
            <div className="flex justify-end items-center gap-2 mt-3">
              <span className="text-sm text-gray-500 dark:text-gray-400">
                Automatically add recurring schedule text
              </span>
              <button
                type="button"
                onClick={updateRecurringSchedule}
                className="inline-flex items-center px-4 py-2 text-sm font-medium text-violet-700 dark:text-violet-300 bg-violet-100 dark:bg-violet-900/50 hover:bg-violet-200 dark:hover:bg-violet-900 rounded-lg transition-colors"
              >
                Add Schedule
              </button>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          >
            ...
            <ChevronDown
              className={cn(
                'w-5 h-5 ml-auto text-gray-400 transition-transform',
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    {
                      key: 'other_habilitative',
                      label: 'Other habilitative services and supplies',
                    },
                  ].map(({ key, label }) => (
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button
            ...
            className={cn(
              'inline-flex items-center px-6 py-2.5 text-sm font-medium text-white rounded-lg shadow-sm transition-colors',
